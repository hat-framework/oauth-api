 ...
 *
 * @(#) $Id: login_with_facebook.php,v 1.5 2016/02/04 03:21:17 mlemos Exp $
 *
 */
	...
	$client->client_id = '1788031274760076'; $application_line = __LINE__;
	$client->client_secret = '20b75f6f5e1d34eb6330d36c664f5197';
	...
	if(($success = $client->Initialize()))
	{
		if(($success = $client->Process()))
		{
			if(strlen($client->access_token))
			{
				...
				$success = $client->CallAPI(
					'https://graph.facebook.com/v2.5/me/friends?fields=id,link,name',
					'GET', array(), array('FailOnAccessError'=>true), $amigos);
/*
				if($success)
				{
